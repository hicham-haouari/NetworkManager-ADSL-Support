...
#define NM_DEVICE_ADSL_HW_ADDRESS "hw-address"
#define NM_DEVICE_ADSL_PERMANENT_HW_ADDRESS "perm-hw-address"
...
void nm_device_adsl_get_address (NMDeviceAdsl *dev,
                                 struct adsl_addr *addr);
